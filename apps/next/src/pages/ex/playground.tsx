...
const PlayGround: NextPage = () => {
  return (
    <div className="h-auto bg-blue-gray-50">
      <ProfileHeader avatarSrc="UNKNOWN" imageSrc="UNKNOWN" profileName="test"></ProfileHeader>
      <form className="flex-auto mt-6 space-y-8 divide-y divide-y-blue-gray-200">

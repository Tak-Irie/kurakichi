import { SideParts } from '@next/ui';
import { NextPage } from 'next';

const Org: NextPage = () => {
  return (
    <div>
      <div className="flex flex-col min-w-0 flex-1 overflow-hidden bg-white">
              ...
              <div>
                ...
                <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
                  ...
                  <div className="hidden sm:block 2xl:hidden mt-6 min-w-0 flex-1">
                    <h1 className="text-2xl font-bold text-gray-900 truncate">Ricardo Cooper</h1>
                  </div>
                </div>
              </div>
                ...
                <dl className="grid grid-cols-1 gap-x-4 gap-y-8 sm:grid-cols-2">
                  ...
                  <div className="sm:col-span-2">
                    ...
                    <dd className="mt-1 max-w-prose text-sm text-gray-900 space-y-5">
                      <p>
                        Tincidunt quam neque in cursus viverra orci, dapibus nec tristique. Nullam
                        ut sit dolor consectetur urna, dui cras nec sed. Cursus risus congue arcu
                        aenean posuere aliquam.
                      </p>
                      <p>
                        Et vivamus lorem pulvinar nascetur non. Pulvinar a sed platea rhoncus ac

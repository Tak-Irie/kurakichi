...
const OrgProfile: FC<OrgProfileProps> = ({
  orgName = 'NPO法人 くらしのあんぜんきち(架空)',
  orgImg = '/hands_mid-reso.jpg',
  orgIcon = '/logo_temp.png',
  email = 'example@example.com',
  phone = '0120-345-6789',
  location = '〒100-0005 東京都千代田区丸の内１丁目',
  homePage = '-',
  description = 'こちらは架空の団体です。入力の参考にして下さい。この欄には団体の説明文をご記入下さい',
  member,
}) => {
  return (
      ...
      <div className="flex-1 relative z-0 flex overflow-hidden">
        ...
        >
          <article className="bg-gray-100">
            <div>
              <img className="h-32 w-full object-cover lg:h-56" src={orgImg} alt="団体イメージ" />
            ...
            <div className="mt-6 max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
              <GridTemplate>
                ...
                <GridItem label="電話番号" content={phone} />

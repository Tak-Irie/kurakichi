...
const GraphqlSchema = makeSchema({
  ...
  outputs: {
    schema:
      ...
      '/Users/tak/development/kurakichi2/apps/express/src/graphql/generated/shcema.graphql',
    typegen:
      // __dirname + '/generated/nexus.d.ts',
      '/Users/tak/development/kurakichi2/apps/express/src/graphql/generated/nexus.d.ts',
  },
  contextType: {
    module:
      // TODO: only dev

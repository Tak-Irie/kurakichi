...
type GetMessagesArg = { userId: string };
...
export class GetMessagesUsecase
  implements IUsecase<GetMessagesArg, Promise<GetMessagesResponse>>
{
  constructor(private MessagesRepo: IMessageRepo) {
    this.MessagesRepo = MessagesRepo;
  }
  public async execute(arg: GetMessagesArg): Promise<GetMessagesResponse> {
    try {

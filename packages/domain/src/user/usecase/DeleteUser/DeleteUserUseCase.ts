...
type DeleteUserResponse = Either<
  UserNotExistsOrDeletedError | UnexpectedError | StoreConnectionError | Result<User>,
  Result<void>
>;

export class DeleteUserUsecase implements IUsecase<DeleteUserArg, Promise<DeleteUserResponse>> {
